...
* Run `docfx` under the current repo! A website will be generated under the `_site` folder.
* Run any web hosting tool to host the `_site` folder, e.g. `docfx serve _site`.
